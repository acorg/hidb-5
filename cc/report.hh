...
namespace hidb
{
    ...
    void report_antigens(const hidb::HiDb& hidb, const indexes_t& aIndexes, report_tables aReportTables, std::string_view aPrefix = {});
    void report_antigen(const hidb::HiDb& hidb, const hidb::Antigen& aAntigen, report_tables aReportTables, std::string_view aPrefix = {});
    inline void report_antigen(const hidb::HiDb& hidb, size_t aIndex, report_tables aReportTables, std::string_view aPrefix = {}) { report_antigen(hidb, *hidb.antigens()->at(aIndex), aReportTables, aPrefix); }
